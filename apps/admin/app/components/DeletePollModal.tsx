      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm bg-zinc-900 rounded-[2.5rem] p-8 shadow-2xl border border-white/5"
          >
            <div className="flex flex-col items-center text-center gap-6">
              ...
              <div className="space-y-2">
                <h3 className="text-2xl font-black uppercase tracking-tight text-white">Delete Poll?</h3>
                <p className="text-gray-500 font-medium leading-relaxed text-sm">
                  This action is permanent and will remove all associated data, including votes and comments.
                </p>
              </div>
              ...
              <div className="flex flex-col w-full gap-3">
                ...
                <button 
                  onClick={onClose}
                  disabled={isDeleting}
                  className="w-full bg-white/5 text-gray-400 h-14 rounded-2xl font-black uppercase tracking-widest hover:text-white transition-all px-6 border border-white/5 disabled:opacity-50"
                >
                  Cancel
                </button>
              </div>
